				...
				<tbody>
					...
					foreach ($addon_name as $key => $value) {
						...
						<tr valign="top">
							...
							<td>
								<input id="<?php echo $value;?>" class="wp_travel_engine_addon_license_key" name="wp_travel_engine_license[<?php echo $value;?>_license_key]" type="text" class="regular-text" value="<?php esc_attr_e( $wte_fixed_departure_license ); ?>" />
