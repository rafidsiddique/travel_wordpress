            ...
            <div class="wp-travel-inner-wrapper">
                <div class="wp-travel-engine-archive-outer-wrap">
                    ...
                    <?php 
                        ...
                        <div class="parent-desc"><p><?php echo isset( $term_description ) ?  $term_description:'';?></p></div>
                    <?php
                    ...
                    foreach( $terms as $term ) {
                        ...
                        if ($my_query->have_posts()) { ?>
                            <div class="details"><h3 class="activity-title"><span><?php echo esc_attr($term->name);?></span></h3>
                                <div class="wrap">
                                    <div class="child-desc"><p><?php echo html_entity_decode(term_description( $term->term_id, 'activities' ));?></p>
                                    </div>
