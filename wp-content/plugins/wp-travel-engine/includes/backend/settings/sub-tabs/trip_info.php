			...
			foreach ( $arr_keys as $key => $value ) { ?>		
				<li id="trip_facts_template-<?php echo $value;?>" data-id="<?php echo esc_attr($value);?>" class="trip_facts">
					...
					<div class="form-builder">
						...
						<div class="field-id">
							<label for="wp_travel_engine_settings[trip_facts][field_id][<?php echo $value;?>]"><?php _e('Field Name:');?><span class="required">*</span></label> 
						...
						<div class="field-icon">
							<label for="wp_travel_engine_settings[trip_facts][field_icon][<?php echo $value;?>]"><?php _e('Field Icon:');?></label> 
						...
						<div class="field-type">
							<label for="wp_travel_engine_settings[trip_facts][field_type][<?php echo $value;?>]"><?php _e('Field Type:');?><span class="required">*</span></label>
