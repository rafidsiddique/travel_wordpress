...
<div class="trip-info-meta">
	<div>
	<label for="wp_travel_engine_booking_setting[place_order][travelers]"><?php _e('Travelers: ','wp-travel-engine');?></label>	
	<input type="number" id="wp_travel_engine_booking_setting[place_order][travelers]" name="wp_travel_engine_booking_setting[place_order][travelers]" value="<?php echo isset($wp_travel_engine_postmeta_settings['place_order']['traveler']) ? esc_attr($wp_travel_engine_postmeta_settings['place_order']['traveler']):'';?>">
	</div>
	<div>
	<label for="wp_travel_engine_booking_setting[place_order][cost]"><?php _e('Total Paid: ','wp-travel-engine');?><?php
	$code = 'USD';
