	...
	{ ?>
		<form name="wte_enquiry_contact_form" id="wte_enquiry_contact_form" action="#" method="POST" enctype="multipart/form-data">
			...
			<div class="row-repeater country-holder">
                ...
                <select  id="enquiry_country" name="enquiry_country" data-placeholder="<?php esc_attr_e( 'Choose a country&hellip;', 'wp-travel-engine' ); ?>" class="wc-enhanced-select" required>
            ...
            <div class="row-repeater contact">
					...
					<input id="enquiry_contact" class="input" name="enquiry_contact" type="text" value="" size="30" placeholder="<?php _e('Enter Your Contact Number', 'wp-travel-engine' ); ?>" required />
            </div>
            <div class="row-repeater adult">
				<label for="enquiry_adult"><?php _e('Adults:','wp-travel-engine');?><span class="required">*</span></label>
				<input id="enquiry_adult" class="input" name="enquiry_adult" type="number" value="" size="30" placeholder="<?php _e('Enter Number of Adults', 'wp-travel-engine' ); ?>" required />
            </div>
            <div class="row-repeater children">
				<label for="enquiry_children"><?php _e('Children:','wp-travel-engine');?></label>
				<input id="enquiry_children" class="input" name="enquiry_children" type="number" value="" size="30" placeholder="<?php _e('Enter Number of Children', 'wp-travel-engine' ); ?>" />
			</div>
            <div class="row-repeater msg-holder">
            	<div class="row-form">
					...
					<textarea id="enquiry_message" class="input" name="enquiry_message" rows="7" cols="30" placeholder="<?php _e('Your Message', 'wp-travel-engine' ); ?>" required ></textarea>
            	</div>
            </div>
            <div class="row-repeater confirm-holder">
                <div class="row-form">
					<label for="enquiry_confirmation"><input type="checkbox" id="enquiry_confirmation" name="enquiry_confirmation" required/><?php _e('Confirmation','wp-travel-engine');?></label>
				</div>
			</div>
			<?php
