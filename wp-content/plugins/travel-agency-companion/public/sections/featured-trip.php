...
if( $title || $content || ( travel_agency_is_wpte_activated() && $trip_cat && $qry->have_posts() ) ){ ?>
<section class="featured-trip" id="featured_section">
	<div class="container">
        ...
        <?php 
        if( travel_agency_is_wpte_activated() && $trip_cat && $qry->have_posts() ){ 
            ...
            <?php 
            $term_link = get_term_link( $trip_cat, 'activities' );
