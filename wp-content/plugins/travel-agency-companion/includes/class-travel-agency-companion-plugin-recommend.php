...
if( ! class_exists( 'Travel_Agency_Plugin_Install_Helper') ){
    return;    
}
 ...
 * A custom text control for Contact info.
 */
class Travel_Agency_Companion_Plugin_Recommend_Control extends WP_Customize_Control {
	...
	public function create_plugin_install_button( $slug ) {
		return Travel_Agency_Plugin_Install_Helper::instance()->get_button_html( $slug );
	}
}
