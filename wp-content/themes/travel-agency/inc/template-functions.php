...
function travel_agency_related_posts(){
    global $post;
    $related_title = get_theme_mod( 'related_title', __( 'You may alo like...', 'travel-agency' ) );
    				...
    				<div class="img-holder">
                        ...
                        <?php 
                            if( has_post_thumbnail() ){
                                ...
                                <img src="<?php echo esc_url( get_template_directory_uri() . '/images/fallback-img-280-170.jpg' ); ?>" alt="<?php the_title_attribute(); ?>" />
                            <?php  
                            }
                        ?>                        
                        </a>
